...
6. **Thai Typography & Line-Height Standards (บรรทัดฐาน Line-Height $\ge 1.5$ สำหรับภาษาไทย)**
   - **สรีระของอักษรไทย (Thai Glyph Stacking):** ตัวอักษรไทยมีวรรณยุกต์และสระซ้อนกันได้ถึง 3 ชั้น (เช่น สระบน `ิ, ี, ึ, ื`, วรรณยุกต์ `่, ้, ๊, ๋`, ไม้ไต่คู้ `็`, ทัณฑฆาต `์`, และสระล่าง `ุ, ู`)
   - **กฎเหล็ก Line-Height $\ge 1.5$:** ใน CSS, HTML, Markdown และ UI Layout ทุกจุดที่มีข้อความภาษาไทย **ต้องกำหนด `line-height` ไม่ต่ำกว่า 1.5 เสมอ** (แนะนำ `1.6` – `1.7` สำหรับเนื้อหาหลัก และขั้นต่ำ `1.5` สำหรับตาราง, การ์ด, และ Callouts)
   - **ผลกระทบหากต่ำกว่า 1.5:** สระล่างของบรรทัดบนจะทับซ้อนกับวรรณยุกต์/สระบนของบรรทัดล่างทันที ทำให้อ่านไม่ออกและผิดหลักสุขอนามัยของ Typography อย่างรุนแรง
...
- [ ] **Line-Height $\ge 1.5$ สำหรับภาษาไทย**: ตรวจสอบว่า CSS `line-height` ทุกจุด $\ge 1.5$ ป้องกันสระบน-ล่างและวรรณยุกต์ทับซ้อนกัน
